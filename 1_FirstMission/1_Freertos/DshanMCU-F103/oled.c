...
void OLED_TEST()
{
  ...
  for(;;)
  {
    ...
    OLED_PrintString(1, 0, "YUQIRI", &font16x16, OLED_COLOR_NORMAL);
    OLED_PrintString(50, 0, "CNT", &font16x16, OLED_COLOR_NORMAL);

	  OLED_DrawRectangle(13,25,101,12,OLED_COLOR_NORMAL);
    OLED_DrawFilledRectangle(13,26,cnt++, 11,OLED_COLOR_NORMAL);
	  if(cnt == 100)
      cnt = 0;
